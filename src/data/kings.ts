...
export const kings: Trainer[] = [
  createKing('plaine-kekette', caillou, 2, 'Ici, c\'est ma street, et tu as trop de cheveux pour pouvoir continuer ton chemin.', 'Tu m\'as bien déglingué, bravo ! Je vais aller me faire un shampoing et je reviendrai bien plus fort !', 'Je vais te faire bouffer tes cheveux espèce de sous merde !'),

...
import bulgrosboule from '~/data/shlagemons/evolutions/bulgrosboule'
import carapouffe from '~/data/shlagemons/evolutions/carapouffe'
import salamiches from '~/data/shlagemons/evolutions/salamiches'
